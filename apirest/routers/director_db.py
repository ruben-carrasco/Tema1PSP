...
def directores():
    return directores_schema(db_client.local.directores.find())
...
async def add_director(director: Director):
    ...
    id = db_client.local.directores.insert_one(director_dict).inserted_id
...
async def modify_directores(id : str, director: Director):
    ...
    try:
        ...
        db_client.local.directores.find_one_and_replace({"_id" : ObjectId(id)}, director_dict)
...
async def delete_director(id: str):
    ...
    director = db_client.local.directores.find_one_and_delete({"_id" : ObjectId(id)})
...
def search_director_id(id: str):
    try:
        director = director_schema(db_client.local.directores.find_one({"_id" : ObjectId(id)}))
...
def search_director(name: str, surname: str):
    ...
    try:
        ...
        director = director_schema(db_client.local.directores.find_one({"name": name, "surname": surname}))
